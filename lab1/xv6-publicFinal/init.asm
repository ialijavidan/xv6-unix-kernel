...
main(void)
{
  ...
  3a:	e8 7b 03 00 00       	call   3ba <dup>
	//
	printf(1, "Ali Javidan, Mohsen Amjadi\n");
  3f:	58                   	pop    %eax
  40:	5a                   	pop    %edx
  41:	68 f0 07 00 00       	push   $0x7f0
  46:	6a 01                	push   $0x1
  ...
  ab:	68 32 08 00 00       	push   $0x832
  b0:	e8 c5 02 00 00       	call   37a <exec>
      printf(1, "init: exec sh failed\n");
  b5:	5a                   	pop    %edx
  b6:	59                   	pop    %ecx
  b7:	68 35 08 00 00       	push   $0x835
  bc:	6a 01                	push   $0x1
